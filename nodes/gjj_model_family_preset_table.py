...
if PromptServer is not None and getattr(PromptServer, "instance", None) is not None:
	PromptServer.instance.routes.get(PRESET_TABLE_API_PATH)(get_model_family_presets_api)


def match_model_family_preset(unet_name: str, presets: list[dict[str, Any]] | None = None) -> dict[str, Any] | None:
