...
def gjjutils_model_family_match_preset(unet_name: str, presets: list[dict[str, Any]] | None = None) -> dict[str, Any]:
...
def gjjutils_model_family_resolve_clip_type(unet_name: str, clip_names: list[str], preferred_type: str = "") -> str:
...
def gjjutils_model_family_get_flux_clip_candidates(clip_models: list[str], default_name: str = "") -> list[str]:
...
def gjjutils_model_family_pick_lora_name(requested: str, available: list[str], fallback: str = "") -> str:
...
def gjjutils_model_family_pick_model_name(requested: str, available: list[str], fallback: str = "") -> str:
