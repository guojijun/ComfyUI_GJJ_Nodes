...
# 导入LatentSync节点
from ..nodes.latentsync_node import NODE_CLASS_MAPPINGS as LATENTSYNC_NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as LATENTSYNC_NODE_DISPLAY_NAME_MAPPINGS
