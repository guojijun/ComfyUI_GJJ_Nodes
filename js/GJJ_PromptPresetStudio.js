...
function getConfigWidget(node) {
	return GJJ_Utils.getWidget(node, CONFIG_STORE_WIDGET);
}
...
function ensureNode(node) {
	...
	compactSingleLineTextWidget(GJJ_Utils.getWidget(node, "正向基础词"));
	compactSingleLineTextWidget(GJJ_Utils.getWidget(node, "反向基础词"));
