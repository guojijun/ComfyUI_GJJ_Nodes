...
function hideInternalWidgets(node) {
	hideWidget(GJJ_Utils.getWidget(node, METHOD_WIDGET));
	hideWidget(GJJ_Utils.getWidget(node, STATUS_WIDGET));
	hideWidget(GJJ_Utils.getWidget(node, SELECTED_METHODS_WIDGET));
}
	...
	beforeRegisterNodeDef(nodeType, nodeData) {
		...
		nodeType.prototype.onNodeCreated = function (...args) {
			...
			stabilizeNode(this);
				...
				GJJ_Utils.refreshNode(this);			setTimeout(() => stabilizeNode(this), 0);

				GJJ_Utils.refreshNode(this);			setTimeout(() => stabilizeNode(this), 80);
		...
		nodeType.prototype.onConfigure = function (...args) {
			...
			const widget = GJJ_Utils.getWidget(this, SELECTED_METHODS_WIDGET);
