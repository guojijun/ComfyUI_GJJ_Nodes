...
function addMiddleClickPan(element) {
    const onMouseDown = (event) => {
        ...
        const onMove = (moveEvent) => {
            ...
            ds.offset[0] = startOffsetX + (moveEvent.clientX - startX) / scale;
            ds.offset[1] = startOffsetY + (moveEvent.clientY - startY) / scale;
...
const STYLE_ID = "gjj-model-preview-override-styles";
const STYLE_TEXT = "/* Palette matched to ComfyUI-MemoryVisualization. */\n\n.kj-pov-root {\n    width: 100%;\n    height: 100%;\n    position: relative;\n    background: #181818;\n    color: #b0b0b0;\n    font: 12px monospace;\n    display: flex;\n    flex-direction: column;\n    overflow: hidden;\n    user-select: none;\n}\n\n.kj-pov-image-area {\n    flex: 1 1 auto;\n    min-height: 80px;\n    position: relative;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    background: #0a0a0a;\n    overflow: hidden;\n}\n\n/* Absolute-fill so latent-resolution previews scale up rather than staying centred-tiny. */\n.kj-pov-img {\n    position: absolute;\n    inset: 0;\n    width: 100%;\n    height: 100%;\n    object-fit: contain;\n    image-rendering: pixelated;\n    display: block;\n}\n\n.kj-pov-placeholder {\n    position: absolute;\n    inset: 0;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    color: #707070;\n    font: 12px monospace;\n    pointer-events: none;\n}\n\n.kj-pov-scrub {\n    position: absolute;\n    left: 0;\n    right: 0;\n    bottom: 0;\n    height: 6px;\n    background: rgba(0, 0, 0, 0.5);\n    cursor: pointer;\n    z-index: 5;\n    transition: height 80ms ease;\n}\n.kj-pov-scrub:hover { height: 10px; }\n.kj-pov-scrub-fill {\n    height: 100%;\n    width: 0%;\n    background: #e67e22;\n    pointer-events: none;\n}\n.kj-pov-scrub.kj-pov-paused .kj-pov-scrub-fill {\n    background: #707070;\n}\n\n.kj-pov-panel-grip {\n    flex: 0 0 5px;\n    background: #2a2a2a;\n    cursor: ns-resize;\n    position: relative;\n    z-index: 4;\n    user-select: none;\n}\n.kj-pov-panel-grip::after {\n    content: '';\n    position: absolute;\n    left: 50%;\n    top: 50%;\n    transform: translate(-50%, -50%);\n    width: 26px;\n    height: 2px;\n    background: #555;\n    border-radius: 1px;\n}\n.kj-pov-panel-grip:hover { background: #3a3a3a; }\n.kj-pov-panel-grip:hover::after { background: #888; }\n\n.kj-pov-panel {\n    flex: 0 0 auto;\n    height: 140px;\n    min-height: 60px;\n    background: #181818;\n    font: 11px monospace;\n    color: #b0b0b0;\n    display: flex;\n    flex-direction: column;\n    overflow: hidden;\n}\n\n.kj-pov-panel-header {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    padding: 4px 10px;\n    gap: 8px;\n    background: #202020;\n    border-bottom: 1px solid #2a2a2a;\n}\n.kj-pov-header-left {\n    display: flex;\n    align-items: center;\n    gap: 8px;\n}\n.kj-pov-panel-title { color: #b0b0b0; font-size: 11px; }\n.kj-pov-panel-summary { color: #707070; font-size: 10px; }\n\n.kj-pov-toggle {\n    background: #2a2a2a;\n    color: #888;\n    border: 1px solid #333;\n    border-radius: 3px;\n    padding: 1px 7px;\n    font: 10px monospace;\n    cursor: pointer;\n    user-select: none;\n}\n.kj-pov-toggle:hover { background: #333; color: #b0b0b0; }\n.kj-pov-toggle.kj-pov-on {\n    background: #3a2a1a;\n    color: #e67e22;\n    border-color: #c66e1a;\n}\n\n.kj-pov-graphs-grid {\n    display: flex;\n    align-items: stretch;\n    padding: 6px 6px 7px;\n    gap: 6px;\n    flex: 1 1 auto;\n    min-height: 0;\n    box-sizing: border-box;\n}\n\n.kj-pov-graph-cell {\n    flex: 1 1 0;\n    min-width: 0;\n    display: flex;\n    flex-direction: column;\n    background: #0e0e0e;\n    border: 1px solid #1c1c1c;\n    border-radius: 3px;\n    overflow: hidden;\n}\n\n.kj-pov-graph-head {\n    flex: 0 0 auto;\n    display: flex;\n    justify-content: space-between;\n    align-items: baseline;\n    padding: 3px 6px 2px;\n    background: #161616;\n    border-bottom: 1px solid #1c1c1c;\n    font-size: 10px;\n    line-height: 1.1;\n    gap: 4px;\n}\n\n.kj-pov-graph-label {\n    color: #707070;\n    letter-spacing: 0.05em;\n    flex: 0 0 auto;\n}\n\n.kj-pov-graph-value {\n    color: #b0b0b0;\n    font-size: 10px;\n    text-align: right;\n    flex: 1 1 auto;\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: nowrap;\n}\n\n.kj-pov-graph-canvas {\n    flex: 1 1 auto;\n    display: block;\n    width: 100%;\n    min-height: 0;\n}";
...
api.addEventListener("gjj_model_preview_override", (e) => {
    const data = e.detail;
    if (!data || data.node_id == null) return;
    const node = findNodeByQualifiedId(app.graph, data.node_id);
    if (node?._gjjModelPreviewHandler) node._gjjModelPreviewHandler(data);
});
...
app.registerExtension({
    name: "GJJ.ModelPreviewOverrideKJ",
    async beforeRegisterNodeDef(nodeType, nodeData) {
        if (nodeData?.name !== "GJJ_ModelPreviewOverrideKJ") return;
        ...
        chainCallback(nodeType.prototype, "onNodeCreated", function () {
            ...
            headerTitle.textContent = "GJJ 采样预览覆盖";
            const headerSummary = el("span", "kj-pov-panel-summary", header);
            headerSummary.textContent = "空闲";

            node.properties = node.properties || {};
            if (typeof node.properties.gjjModelPreviewPanelH === "number") {
                panel.style.height = node.properties.gjjModelPreviewPanelH + "px";
            }
            ...
            grip.addEventListener("mousedown", (e) => {
                ...
                const up = () => {
                    ...
                    node.properties.gjjModelPreviewPanelH = panel.offsetHeight;
                    node.graph?.change?.();
                };
            ...
            const timeRow = makeCell("单步耗时（毫秒）");
            sdRow.canvas.style.cursor = "crosshair";
            sdRow.canvas.title = "悬停查看采样步；单击锁定；方向键逐步查看；再次单击解除锁定";
            timeRow.canvas.title = "单击切换毫秒与秒";
            ...
            function renderTime() {
                timeRow.lbl.textContent = timeUnitSeconds ? "单步耗时（秒）" : "单步耗时（毫秒）";
                ...
                if (lastAvgStepMs != null && lastTotal != null && lastStep != null) {
                    ...
                    const avgTxt = timeUnitSeconds
                        ? `${(lastAvgStepMs / 1000).toFixed(2)}秒/步`
                        : `${lastAvgStepMs.toFixed(0)}毫秒/步`;
                    headerSummary.textContent = `${lastW}×${lastH} · ${lastStep}/${lastTotal} · ${avgTxt} · 剩余 ${eta.toFixed(1)}秒`;
                }
            }
            ...
            node.addDOMWidget("preview", "gjj_model_preview", root, { serialize: false });
            ...
            const handler = (data) => {
                try {
                    ...
                    console.warn("[GJJ.ModelPreviewOverrideKJ] preview decode failed:", err);
                }
            };
            node._gjjModelPreviewHandler = handler;

            chainCallback(node, "onRemoved", function () {
                node._gjjModelPreviewHandler = null;
                resetFrames();
                stopVideoLoop();
