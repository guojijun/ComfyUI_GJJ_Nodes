...
app.registerExtension({
	...
	async beforeRegisterNodeDef(nodeType, nodeData) {
		...
		nodeType.prototype.onExecuted = function (message) {
			...
			// 后端返回可能是执行前的旧 preview_segments；界面以 properties.segments 为准，避免拖动后被旧数据刷回。
			this._editor.setSegments(propertySegments.length ? propertySegments : (segments.length ? segments : this._editor.makeDefaultSegment()));
