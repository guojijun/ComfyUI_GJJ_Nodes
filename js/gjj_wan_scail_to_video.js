...
const INPUT_SPECS = [
	...
	["background_image", "IMAGE", null, "背景图", "SCAIL-2 可选。动画模式下用于把参考图按遮罩合成到背景上。"],
	["reference_image", "IMAGE", null, "参考图片", "可选主参考图；无有效数据时自动忽略。"],
	["reference_image_mask", "IMAGE", null, "参考图彩色遮罩", "SCAIL-2 可选。主参考图对应的彩色身份遮罩。"],
	["multi_reference_images", "IMAGE", null, "多参考图", "SCAIL-2 可选。多张参考图会逐张编码并追加到 reference_latents。"],
	["multi_reference_masks", "IMAGE", null, "多参考图遮罩", "SCAIL-2 可选。多参考图对应彩色遮罩；数量不足会复用最后一张。"],
