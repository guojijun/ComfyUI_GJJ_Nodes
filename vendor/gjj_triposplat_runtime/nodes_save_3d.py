...
from .geometry_types import MESH
...
def save_glb(vertices, faces, filepath, metadata=None,
    ...
    materials = []
    extensions_used = []
    has_vertex_color = "COLOR_0" in primitive_attributes
    use_unlit = bool(unlit or has_vertex_color)
    if texture_png_bytes is None and (use_unlit or has_vertex_color):
...
class SaveGLB(IO.ComfyNode):
    ...
    @classmethod
    def execute(cls, mesh: MESH | Types.File3D, filename_prefix: str) -> IO.NodeOutput:
