...
def _optional_model_path(category, filename):
    try:
        return folder_paths.get_full_path(category, filename)
    except Exception:
        return None
...
class Config:
    def __init__(self, bb_index: int = 6) -> None:
        ...
        self.weights = {
            'pvt_v2_b2': _optional_model_path(weight_paths_name, 'pvt_v2_b2.pth'),
            'pvt_v2_b5': _optional_model_path(weight_paths_name, ['pvt_v2_b5.pth', 'pvt_v2_b5_22k.pth'][0]),
            'swin_v1_b': _optional_model_path(weight_paths_name, ['swin_base_patch4_window12_384_22kto1k.pth', 'swin_base_patch4_window12_384_22k.pth'][0]),
            'swin_v1_l': _optional_model_path(weight_paths_name, ['swin_large_patch4_window12_384_22kto1k.pth', 'swin_large_patch4_window12_384_22k.pth'][0]),
            'swin_v1_t': _optional_model_path(weight_paths_name, ['swin_tiny_patch4_window7_224_22kto1k_finetune.pth'][0]),
            'swin_v1_s': _optional_model_path(weight_paths_name, ['swin_small_patch4_window7_224_22kto1k_finetune.pth'][0]),
            'pvt_v2_b0': _optional_model_path(weight_paths_name, ['pvt_v2_b0.pth'][0]),
            'pvt_v2_b1': _optional_model_path(weight_paths_name, ['pvt_v2_b1.pth'][0]),
        }
