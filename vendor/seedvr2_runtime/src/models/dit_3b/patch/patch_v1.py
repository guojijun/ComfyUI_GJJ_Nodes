...
class PatchIn(nn.Module):
    def __init__(self, in_channels: int, patch_size: Union[int, Tuple[int, int, int]], dim: int):
        super().__init__()
    ...
    def forward(self, vid: torch.Tensor) -> torch.Tensor:
        ...
        return self.proj(vid)


class PatchOut(nn.Module):
    def __init__(self, out_channels: int, patch_size: Union[int, Tuple[int, int, int]], dim: int):
        super().__init__()
        t, h, w = _triple(patch_size)
        self.patch_size = t, h, w
